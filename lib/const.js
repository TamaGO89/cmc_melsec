...
//---------------------------------------------------------------------------------------------
// TYPE ENCODER : dictionary of functions to encode typed data into buffer array
const TYPE_ENCODER = {
	// BOOL : TODO : Add support for bool type (each bool gets 4 bits if bit addressed or 1 bit if word addressed)
	BOOL: function(b,v,o) { b[o*4|0] += v<<!(o*4%1)*4; return o+0.125; },
	INT: function(b,v,o) { return b.writeInt16LE(v,o); },
	DINT: function(b,v,o) { return b.writeInt32LE(v,o); },
	WORD: function(b,v,o) { return b.writeUInt16LE(v,o); },
	DWORD: function(b,v,o) { return b.writeUInt32LE(v,o); },
	REAL: function(b,v,o) { return b.writeFloatLE(v,o); },
	LREAL: function(b,v,o) { return b.writeDoubleLE(v,o); },
	string: function(b,v,o,l) { return b.fill(0,o+b.write(v,o,l,"ascii"), o+l);},
	wstring: function(b,v,o,l) { return b.fill(0,o+b.write(v,o,l,"utf16le"), o+l);}
};
//---------------------------------------------------------------------------------------------
// TYPE ENCODER : dictionary of functions to decode typed data from buffer array
const TYPE_DECODER = {
	// BOOL : TODO : Add support for bool type (each bool gets 4 bits if bit addressed or 1 bit if word addressed)
	BOOL: function(b,o) { return (b[o|0] >> (o*8&7)) & 1; },
	INT: function(b,o) { return b.readInt16LE(o); },
	DINT: function(b,o) { return b.readInt32LE(o); },
	WORD: function(b,o) { return b.readUInt16LE(o); },
	DWORD: function(b,o) { return b.readUInt32LE(o); },
	REAL: function(b,o) { return b.readFloatLE(o); },
	LREAL: function(b,o) { return b.readDoubleLE(o); },
	string: function(b,o,l) { return b.toString("ascii",o,o+l); },
	wstring: function(b,o,l) { return b.toString("utf16le",o,o+l); }
};
